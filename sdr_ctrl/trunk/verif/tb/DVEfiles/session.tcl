...
# DVE full session
# Saved on Thu Dec 6 17:32:12 2018
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{2 51} {1363 738}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 123} {height 123} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 337} {height 123} {dock_state left} {dock_on_new_line true} {child_data_colvariable 171} {child_data_colvalue 100} {child_data_coltype 71} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 473]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1306
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 473
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1361} {height 472} {dock_state bottom} {dock_on_new_line true}}
...
# Restore C1 time
gui_set_time -C1_only 105280000
...
gui_view_scroll -id ${Source.1} -vertical -set 176
